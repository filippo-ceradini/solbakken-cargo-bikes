...
const homePage = (socket) => () => {
    ...
    console.log(email)
    socket.emit("homePageResponse", {
        message: `Hi ${email}, Welcome to the home page`,
    });
}
const testSession = (socket) => () => {
    socket.emit("testSessionResponse", { session: socket.request.session });
};

export {login, logout, homePage, testSession};
